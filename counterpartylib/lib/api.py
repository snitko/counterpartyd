    ...
    def run(self):
        ...
        def unpack(data_hex):
            ...
            for message_type in API_TRANSACTIONS:
                if message_type_id == sys.modules['counterpartylib.lib.messages.{}'.format(message_type)].ID:
                    unpack_method = sys.modules['counterpartylib.lib.messages.{}'.format(message_type)].unpack
